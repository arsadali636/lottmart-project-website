        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-start gap-3 text-[0.95rem] leading-relaxed">
            ...
            <div className="flex flex-col gap-1.5">
              <a href="tel:+919528353168" className="block text-zinc-300 hover:text-primary transition-colors">+91 95283 53168</a>
              <a href="tel:+918126177819" className="block text-zinc-300 hover:text-primary transition-colors">+91 81261 77819</a>
              <a href="tel:+918126044585" className="block text-zinc-300 hover:text-primary transition-colors">+91 81260 44585</a>
              <a href="tel:+917808774054" className="block text-zinc-300 hover:text-primary transition-colors">+91 78087 74054</a>
            </div>
          </div>
